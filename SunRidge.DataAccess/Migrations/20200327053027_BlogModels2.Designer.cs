...
namespace Sunridge.DataAccess.Migrations
{
    ...
    [Migration("20200327053027_BlogModels2")]
    partial class BlogModels2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sunridge.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sunridge.Models.Reply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sunridge.Models.Thread", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sunridge.Models.BlogImage", b =>
                {
                    b.HasOne("Sunridge.Models.Comment", "Comment")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Sunridge.Models.Comment", b =>
                {
                    ...
                    b.HasOne("Sunridge.Models.Thread", "Thread")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Sunridge.Models.Reply", b =>
                {
                    b.HasOne("Sunridge.Models.Comment", null)
                        .WithMany("Replies")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
